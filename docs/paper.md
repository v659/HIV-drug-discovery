...
**AI assistance disclosure.** I used Anthropic's Claude (Claude Code) for manuscript drafting, code review, and figure-generation tooling. All experimental design, training and evaluation runs, statistical analyses, and final claims are mine; the trained models and reported numbers are produced by the code in this repository, not generated by an AI.
